...
export const App = () => {
  return (
    <section className="p-10 bg-bg flex justify-center md:px-20 md:py-24 shadow">
      ...
      <div className="z-10 w-full max-w-screen-2xl h-full bg-panel shadow-lg shadow-black ring-1 ring-secondaryPanel">
        <Navbar />
        <Home />
      </div>
    </section>
